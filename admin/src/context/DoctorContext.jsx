...
const DoctorContextProvider = (props) => {
    ...
    const compeleteAppointment = async (appointmentId) => {
        try {


            const {data}=await axios.post(backendUrl +'api/doctor/compelete-appointment',{appointmentId},{ headers: { token: dToken } })
            if(data.success){
    ...
    const value = {
        ...
        compeleteAppointment,cancelAppointment,
